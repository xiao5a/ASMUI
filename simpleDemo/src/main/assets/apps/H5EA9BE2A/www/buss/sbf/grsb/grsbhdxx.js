	...
	function init() {
		...
		var minYear = nowYear-15;
		var maxYear = nowYear+15;
		if(nowMonth < 7){
			minYear = nowYear-1;
			maxYear = nowYear;
		}
	...
	//选择缴费档次
	function chosejfdc() {
		$("#jfdc span").attr("class","mui-icon mui-icon-arrowup")
		...
		picker.show(function(items) {
			$("#jfdc span").attr("class","mui-icon mui-icon-arrowdown")
	...
	function chosexzlx() {
		...
		$("#jklx span").attr("class","mui-icon mui-icon-arrowup")
		picker.show(function(items) {
			$("#jklx span").attr("class","mui-icon mui-icon-arrowdown")
	...
	//选择所属期起
	function chosessqq(){
		$("#ssqq span").attr("class","mui-icon mui-icon-arrowup")
		vm.ssqqdtPicker= new mui.DtPicker(vm.dtoption);
		var dtPicker = vm.ssqqdtPicker 
		dtPicker.show(function (selectItems) { 
			$("#ssqq span").attr("class","mui-icon mui-icon-arrowdown")
	...
	//选择所属期止
	function chosessqz(){
		$("#ssqz span").attr("class","mui-icon mui-icon-arrowup")
		vm.ssqqdtPicker= new mui.DtPicker(vm.dtoption);
		var dtPicker = vm.ssqqdtPicker 
		dtPicker.show(function (selectItems) { 
			$("#ssqz span").attr("class","mui-icon mui-icon-arrowdown")
